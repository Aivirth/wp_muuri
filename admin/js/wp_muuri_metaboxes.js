(function () {
    ...
    document.addEventListener('DOMContentLoaded', e => {
        ...
        function muuriAddItemsToGallery() {
            ...
            if (wpMuuriAddBtn) {
                wpMuuriAddBtn.addEventListener('click', (e) => {
                    ...
                    const wpGalleryImages = wp.media({
                        title: 'Upload Images',
                        multiple: 'add'
                    }).open().on('select', (e) => {
                        const wpGalleryUploadedImages = wpGalleryImages.state().get('selection');
                        const wpGallerySelectedImages = wpGalleryUploadedImages.toJSON();
                        const wpGalleryItems = [];
                        const wpGalleryImagesSelectedList = document.querySelector('#wpMuuriGallery__list');
                        ...
                        if (wpGalleryImagesSelectedList) {
                            wpGalleryImagesSelectedList.insertAdjacentHTML('afterbegin', wpGalleryItems);
        ...
        function muuriDeleteItemFromGallery() {
            ...
            const wpMuuriGalleryListContainer = document.getElementById('wpMuuriGallery__list');
        ...
        function muuriUpdateGalleryJson() {
            ...
            const muuriHiddenInput = document.getElementById('wpMuuriGallery__galleryInputHidden');

            if (muuriHiddenInput) {

                const currentItemsInList = [...document.getElementsByClassName('wpMuuriGallery__item')];
