(function () {
    document.addEventListener('DOMContentLoaded', (e) => {
        ...
        function muuriAddItemsToGallery() {
            const wpMuuriAddBtn = document.querySelector(
                '#wpMuuriGallery__add'
            );
                ...
                wpMuuriAddBtn.addEventListener('click', (e) => {
                    const wpGalleryImages = wp
                        ...
                        .on('select', (e) => {
                            ...
                            // console.log(wpGallerySelectedImages);
                    ...
                    if (
                        ...
                        if (
                            galleryItem.classList.contains(
                                'wpMuuriGallery__item'
                            ) &&
                            galleryItem.dataset.galleryItemId === delBtnItemID
                        ) {
                            wpMuuriGalleryListContainer.removeChild(
                                galleryItem
                            );
                        }
                    }
